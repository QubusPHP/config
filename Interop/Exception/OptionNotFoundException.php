...
namespace Qubus\Config\Interop\Exception;
...
class OptionNotFoundException extends OutOfBoundsException
{
     ...
     */
    public static function missingOptions(RequiresConfig $factory, $currentDimension, ?string $configId = null): self
    {
        $position = [];

        $dimensions = $factory->dimensions();
        $dimensions = $dimensions instanceof \Traversable ? iterator_to_array($dimensions) : $dimensions;
