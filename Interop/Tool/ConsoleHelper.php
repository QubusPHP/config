...
class ConsoleHelper
{
    ...
    public const string HIGHLIGHT_INFO = 'info';
    public const string HIGHLIGHT_VALUE = 'value';
    public const string HIGHLIGHT_ERROR = 'error';
    ...
    public function readLine(string $name, string $text = 'Please enter a value for'): string
    {
        ...
        return rtrim(fread($this->inputStream, 1024), "\r\n");
    }
